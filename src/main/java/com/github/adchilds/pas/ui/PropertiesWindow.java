...
/**
 * This class constructs a modal dialog box that allows the user to change program properties such as modifying the
...
public class PropertiesWindow extends JDialog implements ActionListener {
    ...
    public PropertiesWindow() {
        ...
        setIconImage(new ImageIcon(ClassLoader.getSystemResource("images/properties_icon.png")).getImage());
        pack();
    ...
    private JPanel northPanel() {
        ...
        JLabel label = new JLabel("Time Delay (ms):");
    ...
    /**
     * Sets the delay by resetting the textfield's text to whatever the user has put into the textfield.
     *
     * @since 1.0
     */
